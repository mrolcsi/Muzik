...
import hu.mrolcsi.muzik.common.view.ConfigurableFragmentPagerAdapter
...
class LibraryFragment : Fragment() {
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    viewModel.pages.observe(viewLifecycleOwner, ConfigurableFragmentPagerAdapter(childFragmentManager).also {
