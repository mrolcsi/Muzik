 ...
 * ```
 */
class ColoredDividerItemDecoration
/**
 ...
 */
  ...
  /**
   * Specifies tint color for the divider drawable.
   *
   * @see Drawable.setTint
   * @param tintColor – Color to use for tinting the divider drawable
   */
  fun setTint(tintColor: Int) {
    mDivider?.setTint(tintColor)
  }
